...
use the native Home Manager `programs.codex` settings alongside the
NixSlop-specific desktop and OMX options:
...
so normal Home Manager settings still own generated Codex files.
...
`homeManagerModules.default`, `homeManagerModules.nixslop`, all seven public
