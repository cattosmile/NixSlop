...
Codex, Kimi Code, and OMX are built by the update workflow and published to the public
...
1. checks the latest stable Codex, Kimi Code, and OMX releases,
...
5. builds and smoke-tests Codex, Kimi Code, and OMX,
